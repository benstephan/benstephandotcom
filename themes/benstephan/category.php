...
<h2 class="text-center">Category: <?php echo single_cat_title(); ?></h2>
<hr>
...
<li><i class="fa fa-archive"></i> <?php $category = get_the_category(); $firstCategory = $category[0]->cat_name; echo $firstCategory; ?>                                
</ul>
<div class="clearfix"></div>
</div>
<div class="col-sm-9">
