! function(e, t) {
    ...
    (x.fn.init = function(e, t, n) {
        ...
        if (n = n || N, "string" == typeof e) {
            ...
            if (o[1]) {
                if (t = t instanceof x ? t[0] : t, x.merge(this, x.parseHTML(o[1], t && t.nodeType ? t.ownerDocument || t : i, !0)), D.test(o[1]) && x.isPlainObject(t))
    ...
    function _() {
        i.removeEventListener("DOMContentLoaded", _), e.removeEventListener("load", _), x.ready()
    }
    ...
    }), x.ready.then = W.then, "complete" === i.readyState || "loading" !== i.readyState && !i.documentElement.doScroll ? e.setTimeout(x.ready) : (i.addEventListener("DOMContentLoaded", _), e.addEventListener("load", _));
    ...
    function Fe(e, t, n) {
        ...
        return (n = n || We(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || re(e) || (s = x.style(e, t)), !h.pixelBoxStyles() && Re.test(s) && _e.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
    }
    ...
    function Ve(e) {
        return x.cssProps[e] || Ye[e] || (e in Xe ? e : Ye[e] = function(e) {
    ...
    x.extend({
        ...
        css: function(e, t, n, i) {
            var o, r, s, a = Y(t);
            return Qe.test(t) || (t = Ve(a)), (s = x.cssHooks[t] || x.cssHooks[a]) && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = Fe(e, t, i)), "normal" === o && t in Ke && (o = Ke[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
        }
    ...
    Wt.href = St.href, x.extend({
        ...
        ajax: function(t, n) {
            ...
            if (h.data && h.processData && "string" != typeof h.data && (h.data = x.param(h.data, h.traditional)), Ft(It, h, n, S), d) return S;
            ...
            if (T = "abort", m.add(h.complete), S.done(h.success), S.fail(h.error), o = Ft(zt, h, n, S)) {
    ...
    h.cors = !!Xt && "withCredentials" in Xt, h.ajax = Xt = !!Xt, x.ajaxTransport(function(t) {
        var n, i;
    ...
    x.ajaxSetup({
        ...
        x.cssHooks[t] = Be(h.pixelPosition, function(e, n) {
...
function(e) {
    "use strict";
    var t, n;
    e.fn.mPageTransition = function(t) {
        var n = e.extend({
                color: "#FFF",
                fadeOutTime: 300,
                fadeInTime: 300
            ...
            i = e("body"),
            o = e(i).css("background-color");
        e(i).css("visibility", "visible").hide().fadeIn(n.fadeInTime), e("a:not(.contact-form), button:not(#open-contact), button:not(.main-header__nav-toggle)").click(function(t) {
            var r = this;
            t.preventDefault(), e(i).animate({
                "background-color": n.color,
                opacity: 0
            }, n.fadeInTime, function() {
                e(i).animate({
                    "background-color": o
                }, n.fadeOutTime, function() {
                    var t = e(r).attr("href");
                    location.href = t
                })
            })
        ...
        e("body").addClass("loaded"), e("body").mPageTransition()
    }), e(document).ready(function() {
        t = e(window).width(), n = e(".main-header__nav-menu li"), e(".main-header__nav-toggle").on("click", function() {
            e(".main-header__nav-hidden").toggleClass("nav-hidden--show")
        }), t < 769 && e(".main-header__nav-hidden").last().prepend(n), e(window).resize(function() {
            var n = e(window).width(),
                i = e(".main-header__nav"),
                o = e(".main-header__nav-hidden"),
                r = e(".main-header__brand").width(),
                s = e(window).width() - 30 - r;
            if (t < n) {
                if (t = n, s > i.width() + 100) {
                    e(".main-header__nav-toggle").removeClass("nav-toggle--show");
                    var a = e(".main-header__nav-hidden li").first();
                    e(".main-header__nav-menu").append(a)
                }
            } else if (t = n, s < i.width()) {
                e(".main-header__nav-toggle").addClass("nav-toggle--show");
                var l = e(".main-header__nav-menu li").last();
                e(o).append(l)
            }
        })
    }), e(window).scroll(function() {
        e(window).scrollTop() >= 5 ? e("#main-header").addClass("shrink") : e("#main-header").removeAttr("class")
    }), e(document).ready(function() {
        e(".regular").slick({
            dots: !0,
            fade: !0,
    ...
    }), e(".wpcf7-list-item").on("click", function() {
        var t = e(this).children('input[type="checkbox"]');
        t.prop("checked", !t.prop("checked")), e(this).toggleClass("clicked")
    }), e(".contact-form").click(function(t) {
        t.preventDefault(), e("#contact-pop-up").animate({
            height: "100vh",
            margin: "0"
        }, 300)
    }), e("#contact-block__name").focus(function() {
        e(this).attr("placeholder", "")
    }), e("#contact-block__email").focus(function() {
        e(this).attr("placeholder", "")
    }), e("#open-contact").on("click", function(t) {
        t.preventDefault();
        var n = e("#contact-block__name").val(),
            i = e("#contact-block__email").val();
        "" != n && "" != i ? (e("#contact-pop-up").animate({
            height: "100vh",
            margin: "0"
        }, 300), e(".pop-name").val(n), e(".pop-email").val(i)) : "" == n && "" == i ? (e("#contact-block__email").addClass("required-text"), e("fieldset:nth-child(1)").prepend("<span>Required</span>"), e("#contact-block__name").addClass("required-text"), e("fieldset:nth-child(2)").prepend("<span>Required</span>")) : "" == n ? (e("#contact-block__name").addClass("required-text"), e("fieldset:nth-child(1)").prepend("<span>Required</span>")) : "" == i ? (e("#contact-block__email").addClass("required-text"), e("fieldset:nth-child(2)").prepend("<span>Required</span>")) : e("#contact-pop-up").animate({
            height: "100vh",
            margin: "0"
        }, 300)
    }), e(".contact-pop-up__close").click(function(t) {
        t.preventDefault(), e("#contact-pop-up").animate({
            height: "0",
            margin: "0"
        }, 300)
